...
from app.schemas.v2.category import CategoryResponse
from app.schemas.v2.supplier import SupplierResponse
...
class ProductRequest(ProductBase):
    ...
    supplier_ids: list[UUID] | None = Field(default=None)
...
class ProductUpdate(BaseModel): # ProductBase também funciona
